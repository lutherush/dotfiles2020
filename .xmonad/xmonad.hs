--xmonad config file
-- Author: lutherus
-- license: um, it is a fucking config file. Do what ever you want
--
------------------------------------------------------------------------
---IMPORTS
------------------------------------------------------------------------
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/lutherus/configs/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/lutherus/configs/xmobar/xmobarrc2"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/lutherus/configs/xmobar/xmobarrc1"
...
myWorkspaces = clickable . (map xmobarEscape) 
               $ ["dev", "www", "sys", "doc", "c++", "lisp", "prolog", "deezer", "steam"]
  where                                                                      
